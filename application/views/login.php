  ...
  data-animsition-out="fade-out">
    <div class="page-content vertical-align-middle">
      <div class="brand">
        ...
        <h2 class="brand-text">SIVRADA Login</h2>
      </div>
      <form method="post" action="<?php echo base_url().'Auth/loginPost'; ?>">
        <div class="form-group">
          <label class="sr-only" for="inputName">Username</label>
          <input type="text" id="username" class="form-control" placeholder="Username" name="usernamess">
        </div>
        <div class="form-group">
          <label class="sr-only" for="inputPassword">Password</label>
          <input type="password" id="password" class="form-control" placeholder="Password" name="passwordss">
        </div>
      ...
      <p><a href="<?php echo base_url(); ?>">Sistem Evaluasi Rancangan Peraturan Daerah</a></p>
